package com.example.Grupo3.Tablas_antes_de_Entity.estado_entidad;
...
public class EstadoEntidad {
    ...
    public EstadoEntidad(Long id, int gestion, int sectorEnt, int subsecEnt, int areaEnt, int subareaent, int nivelInst, String desEstruct, String siglaestru, String apropiable) {
        this.id = id;
        this.gestion = gestion;
        this.sectorEnt = sectorEnt;
        this.subsecEnt = subsecEnt;
        this.areaEnt = areaEnt;
        this.subareaent = subareaent;
        this.nivelInst = nivelInst;
        this.desEstruct = desEstruct;
